...
var sname=document.myform.spname.value;
if(sname == ""){
document.getElementById("message12").innerHTML =" ** Please fill the Specilisation field **";
return false;
}
var hnames=document.myform.hosname.value;
if(hnames == ""){
document.getElementById("message13").innerHTML =" ** Please fill the Hospital Name field **";
return false;
}
var hpin=document.myform.hospin.value;
if(hpin == ""){
document.getElementById("message14").innerHTML =" ** Please fill the Hospital Pin field **";
return false;
}
var hplace=document.myform.hosplace.value;
if(hplace == ""){
document.getElementById("message15").innerHTML =" ** Please fill the Hospital Place field **";
return false;
}
var file1 = document.myform.files.value;
if( file1 == ""){
document.getElementById("message16").innerHTML =" ** Please Upload the Doctors Id  **";
return false;
}

var file2 = document.myform.filed.value;
if( file2 == ""){
document.getElementById("message17").innerHTML =" ** Please Upload the Doctors Image **";
return false;
}
...
<body>
 <div class="container">
        ...
        <form id="contact" name="myform" action="doctor_connect.php" onsubmit ="return verify_firstname()" method="post">
...
<fieldset>
                    <input type="text" placeholder="Last name *" name="lastname" id="lastname" required autofocus>
...
<span id = "message10" style="color:blue"> </span>
 ...
 <span id = "message11" style="color:blue"> </span>
                        ...
                        <fieldset>
                            ...
                            <input type="text" placeholder="Specilisation *" name="spname" id="spname"   autofocus>
...
<fieldset>
                        <input type="text" placeholder="Hospital Name *" name="hosname" id="hosname"   autofocus>
<span id = "message13" style="color:blue"> </span>
                        </fieldset>

                        <fieldset>

                            <input type="text" placeholder="Hospital Place *" name="hosplace" id="hosplace"   autofocus>
<span id = "message15" style="color:blue"> </span>
                        </fieldset>
                        <fieldset>

                            <input type="text" placeholder="Hospital Pincode *" name="hospin" id="hospin"   autofocus>
<span id = "message14" style="color:blue"> </span>
                        </fieldset>

                        <fieldset>
                       <p>Upload Doctors ID</p>
                            <input type="file" id="files"   >
<span id = "message16" style="color:blue"> </span>
                        </fieldset>
                        
<p>Upload Your Image</p>
                            <input type="file" id="filed"  >
<span id = "message17" style="color:blue"> </span>
                        </fieldset>
